...
interface AuthContextType {
  ...
  loading: boolean;
  signUp: (email: string, password: string, fullName: string, role: 'student' | 'instructor') => Promise<{ error: any }>;
...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <AuthContext.Provider value={{ user, session, loading, signUp, signIn, signOut, isInstructor }}>
      {children}
